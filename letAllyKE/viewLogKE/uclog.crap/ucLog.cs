...
namespace viewLogKE
{
    ...
    public partial class ucLog : UserControl
    {
        ...
        private void set_cbx(ComboBox cbxE, ComboBox cbxS, int shift, string gang)
        {
            ...
            cbxE.DataSource = qryGang.GetView(gang);
        ...
        private int set_row(ComboBox cbxE, ComboBox cbxS, TextBox txtID, TextBox tbxA,
            TextBox tbxO, TextBox tbxP, CheckBox chkH, DataRow row)
        {
        ...
        {
            if (idx == 1)
                cbxS1.SelectedIndex = set_row(cbxE1, cbxS1, txtID1, tbxA1, tbxO1, tbxP1, chkH1, row);
            else if (idx == 2)
                cbxS5.SelectedIndex = set_row(cbxE5, cbxS5, txtID5, tbxA5, tbxO5, tbxP5, chkH5, row);
            else if (idx == 3)
            {
                if (dh_idx < 3) cbxS4.SelectedIndex = set_row(cbxE4, cbxS4, txtID4, tbxA4, tbxP4, tbxP4, chkH4, row);
            }
        }
        ...
        {
            if (idx == 1)
                cbxS2.SelectedIndex = set_row(cbxE2, cbxS2, txtID2, tbxA2, tbxO2, tbxP2, chkH2, row);
            else if (idx == 2)
                cbxS3.SelectedIndex = set_row(cbxE3, cbxS3, txtID3, tbxA3, tbxO3, tbxP3, chkH3, row);
            else if (idx == 3)
            {
                if (skip_idx < 3)
                    cbxS4.SelectedIndex = set_row(cbxE4, cbxS4, txtID4, tbxA4, tbxP4, tbxP4, chkH4, row);
                else
                    cbxS8.SelectedIndex = set_row(cbxE8, cbxS8, txtID8, tbxA8, tbxP8, tbxP8, chkH8, row);
            }
        }
        ...
        private void clear_row(ComboBox cbxE, ComboBox cbxS, TextBox txtID, TextBox tbxA,
            TextBox tbxO, TextBox tbxP, CheckBox chkH, Label lblD)
        {
            cbxS.SelectedIndex = -1;
            cbxE.SelectedIndex = -1;

            //cbxE.Text = string.Empty;
        ...
        {            
            ...
            clear_row(cbxE1, cbxS1, txtID1, tbxA1, tbxO1, tbxP1, chkH1, lblD1);
            clear_row(cbxE2, cbxS2, txtID2, tbxA2, tbxO2, tbxP2, chkH2, lblD2);
            clear_row(cbxE3, cbxS3, txtID3, tbxA3, tbxO3, tbxP3, chkH3, lblD3);
            clear_row(cbxE4, cbxS4, txtID4, tbxA4, tbxO4, tbxP4, chkH4, lblD4);
            clear_row(cbxE5, cbxS5, txtID5, tbxA5, tbxO5, tbxP5, chkH5, lblD5);
            clear_row(cbxE6, cbxS6, txtID6, tbxA6, tbxO6, tbxP6, chkH6, lblD6);
            clear_row(cbxE7, cbxS7, txtID7, tbxA7, tbxO7, tbxP7, chkH7, lblD7);
            clear_row(cbxE8, cbxS8, txtID8, tbxA8, tbxO8, tbxP8, chkH8, lblD8);
