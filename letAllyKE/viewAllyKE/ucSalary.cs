...
namespace viewAllyKE
{
    public partial class ucSalary : UserControl
    {
        ...
        public ucSalary(DateTime start_week, string emp_name, string emp_id, bool _db)
        {
            constructor(start_week);
        ...
        private string show_day(TextBox tbx, string toff, float hours)
        {
...
\*******************************************************************************************************************/
        ...
        *                                                                                                                 *
        ...
        {
            apply_hour(0, (TextBox)sender);
            return;
                
            //if (_boats == null)
            //{
            //    //apply0_code(tbxMH, StatCode);
            //    applyB_code(tbxMH, 0, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(1, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply0_code(tbxTH, StatCode);
            //    applyB_code(tbxTH, 1, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(2, (TextBox)sender); 
            return;

            //if (_boats == null)
            //{
            //    //apply0_code(tbxWH, StatCode);
            //    applyB_code(tbxWH, 2, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(3, (TextBox)sender); 
            return;

            //if (_boats == null)
            //{
            //    //apply0_code(tbxThH, StatCode);
            //    applyB_code(tbxThH, 3, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(4, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply0_code(tbxFH, StatCode);
            //    applyB_code(tbxFH, 4, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(5, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply0_code(tbxSaH, StatCode);
            //    applyB_code(tbxSaH, 5, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(6, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply0_code(tbxSuH, StatCode);
            //    applyB_code(tbxSuH, 6, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(7, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply1_code(tbxMH2, StatCode);
            //    applyB_code(tbxMH2, 7, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        private void tbxTH2_Click(object sender, EventArgs e)
        {
            ...
            //    applyB_code(tbxTH2, 8, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(9, (TextBox)sender); 
            return;

            //if (_boats == null)
            //{
            //    //apply1_code(tbxWH2, StatCode);
            //    applyB_code(tbxWH2, 9, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(10, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply1_code(tbxThH2, StatCode);
            //    applyB_code(tbxThH2, 10, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(11, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply1_code(tbxFH2, StatCode);
            //    applyB_code(tbxFH2, 11, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(12, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply1_code(tbxSaH2, StatCode);
            //    applyB_code(tbxSaH2, 12, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        {
            apply_hour(13, (TextBox)sender);
            return;

            //if (_boats == null)
            //{
            //    //apply1_code(tbxSuH2, StatCode);
            //    applyB_code(tbxSuH2, 13, StatCode, ShiftVessel);
            //    make_dirty();
            //}
            //else
            //{
        ...
        //{
        //    HourClick(Convert.ToInt32(((TextBox)sender).Tag));
        //}
