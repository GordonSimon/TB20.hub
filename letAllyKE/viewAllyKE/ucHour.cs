...
namespace viewAllyKE
{
    public partial class ucHour : UserControl
    {
        ...
        private float _hour { get; set; }
        private float _over { get; set; }
        ...
        public ucHour(string emp_id, DateTime day, float hour, float over, string vessel)
        {
            //InitializeComponent();
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            _hour = Convert.ToSingle(tbxHour.Text);
            _over = Convert.ToSingle(tbxOver.Text);
